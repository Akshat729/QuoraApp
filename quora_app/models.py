...
class Question(models.Model):
    ...
    author = models.ForeignKey(User, on_delete=models.CASCADE, related_name="question") # user who post the question
...
class Answer(models.Model):
    ...
    questions = models.ForeignKey(Question, on_delete=models.CASCADE, related_name="answers")       # question for which user gives the answer
